    ...
    <div class="user">
      <div class="user-information">
        <div class="image-container">
          <img src="https://celfonica.s3-us-west-1.amazonaws.com/Icons/sun.png" alt="profile picture">
        </div>
        <h3>{{ username }}</h3>
      </div>
...
<style scoped>
  ...
  .user-information .image-container {
    width: 100px;
    height: 100px;
    border-radius: 50px;
    margin-right: 2rem;
